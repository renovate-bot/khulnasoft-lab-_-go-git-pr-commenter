...
import (
	...
	change_report "github.com/khulnasoft-lab/go-git-pr-commenter/pkg/commenter/utils/change-report"
...
func (c *BitbucketServer) RemovePreviousKhulnasoftComments(msg string) error {
